...
export default function AssessmentPage() {
  ...
  const canNext = () => getMissingFields().length === 0
                    ...
                    <div className="flex gap-2">
                      {[
                        ...
                        <button
                          ...
                          className={`flex-1 py-2 rounded-lg text-xs font-medium border-2 transition-all ${form.assessmentDifficulty === value ? "border-purple-600 bg-purple-100 text-purple-900" : "border-purple-200 text-muted-foreground hover:border-purple-400"
                            }`}
                        >
                    ...
                    <div className="flex gap-2">
                      {[1, 2, 3, 4, 5].map((num) => (
                        <button
                          ...
                          className={`flex-1 py-2 rounded-lg text-sm font-semibold border-2 transition-all ${form.accuracy === num ? "border-pink-600 bg-pink-100 text-pink-900" : "border-pink-200 text-muted-foreground hover:border-pink-400"
                            }`}
                        >
                          {num}
                        </button>
